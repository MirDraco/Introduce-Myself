...
- [ ] 캐릭터별 배경 디자인 다시 하기
- [ ] 캐릭터별 배경 애니메이션 효과 주기
- [x] 캐릭터마다 있는 뒷 배경 테마를 전환할 수 있게 만들기
- [x] JS를 활용한 캐릭터 사진 누르면 확대와 전환 가능 기능 (Lightbox 라이브러리 적용됨)
- [x] Masonry 스타일 갤러리 레이아웃 구현 (CSS Multi-column 활용)
- [x] 로그인 기능 만들기 (Firebase Authentication 적용 완료)
- [x] 회원가입 기능 만들기
- [ ] 사진 업로드 기능 만들기
- [x] 메모/블로그 만들기 (정적 페이지로 구현 완료)
- [ ] 내 캐릭터는 몇살일까요? 만들기
...
- [x] **서버 압축(Compression) 적용**: Gzip/Brotli 미들웨어 추가 완료
